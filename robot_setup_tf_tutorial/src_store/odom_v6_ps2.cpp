...
void commandCallback_ps2(const geometry_msgs::Twist &cmd_msg_ps2)
{
    // toc do KEYBOARD gui xuong : v/ph
    vx = cmd_msg_ps2.linear.x; // m/s
    vy = cmd_msg_ps2.linear.y; // m/s
    vth = cmd_msg_ps2.angular.z; // rad/s
}
...
int main(int argc, char** argv){
  ...
  ros::NodeHandle n;
  ros::Subscriber sub = n.subscribe("/cmd_vel_ps2", 100, commandCallback_ps2);
